 ...
 * DEL AÃ‘O SE GUARDAN DE LA SIGUIENTE FORMA DIA + ESPACIO + HABITO+ GUION
...
public class App {
	...
	public static void añadirProgreso() {
		 ...
		 * IMPRIMER LA PREGUNTA ASI "Â¿Que cantidad de "+pre[2]+"(s) ha cumplido?"
		 * pre[2] en este casi es horas entonces seria "Â¿Que cantidad de horas(s) ha
		 ...
		 * ESTE METODO EN LA MATRIZ DE LOS DIAS DEL AÃ‘O CAMBIA EN EL DIA SE HABITO EL
	...
	public static void eliminarHabito() {
		 ...
		 * AÃ‘O Y AQUI NO SE NECESITA SABER QUE HABITOSESTAN VIGENTES O FINALIZADOS SI
...
//cal.mostraragendadia(mot, dai);
	...
	public static void verAgendaMes() {
		...
		System.out.println("Â¿DESEA VER LOS HABITOS DEL MES?");
		/**
