...
public class Calendario {
	 ...
	 * LOS DIAS DEL A�O parth ARREGLO EN DONDE QUDA LA INFORMACION FINAL QUE SE VA
	 * PASAR AL ARCHIVO DE LA BASE DE DATOS DE LOS HABITOS matrizago CORRESPONDE A
	 * LA MATRIZ EN DONDE SE PASA LA INFORMACION DE TODOS LOS DIAS DEL AÑO EN ESTA
  ...
  private  String partacfi [];
	...
	public void eliminarhab(String eh) {
		 ...
		 * CICLOS FOR LOS CUALES BUSCAN EN TODA LA MATRIZ DE LOS DIAS DE AÑO EL HABITO
...
System.out.println("habito eliminado con exito");
	...
	public String imprimirpre(String ha) {
		 ...
		 * el array[2] Y SE MUESTRA LA PREGUNTA ASI ¿Que cantidad de horas(s) ha
		 * cumplido?
		 * 
		 * 
		 */
